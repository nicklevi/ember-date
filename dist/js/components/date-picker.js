define('ember-date-components/components/date-picker', ['exports', 'ember', '../templates/components/date-picker', 'moment'], function (exports, _ember, _templatesComponentsDatePicker, _moment) {
  'use strict';
